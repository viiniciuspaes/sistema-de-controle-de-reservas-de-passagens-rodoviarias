...
def create_tables():
    ...
    trajeto_horario = "CREATE TABLE IF NOT EXISTS Trajeto_Horario (CodTrajetoHorario INTEGER NOT NULL AUTO_INCREMENT," \
                      " CodEmpresa INTEGER NOT NULL REFERENCES Empresa(CodEmp) ," \
                      " CodMunicio INTEGER NOT NULL REFERENCES Municipio(CodMunicipio)," \
                      " CodMunicipioDest INTEGER NOT NULL REFERENCES Municipio(CodMunicipio)," \
    ...
    viagem = "CREATE TABLE IF NOT EXISTS Viagem( CodTrajetoHorario INTEGER NOT NULL, Data VARCHAR(7) NOT NULL ," \
             ...
             " FOREIGN KEY (CodTrajetoHorario) REFERENCES Trajeto_Horario(CodTrajetoHorario));"
    execute_sql(viagem)
